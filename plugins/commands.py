...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/+RJ5z0YIRewsxYWNl')
                ],[
                  InlineKeyboardButton('🔗 Sʜᴏʀᴛɴᴇʀ Sɪᴛᴇ 🔗', url='https://zipshort.net/ref/CinemaVilla')
                ],[
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink zipshort.net f037e10475dd1a9e4a9f163787a6bbc3c8c708ab</code></b>")
